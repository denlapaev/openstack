...
/**
 * All classes which implement this interface are a data representation of a remote DenLapaev\OpenStack API.
 * They do not execute functionality, but instead return data for each API operation for other parts
 * of the SDK to use. Usually, the data is injected into {@see DenLapaev\OpenStack\Common\Api\Operation} objects.
